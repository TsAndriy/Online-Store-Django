...
class Customer(models.Model):
    ...
    orders = models.ManyToManyField('Order', verbose_name='Buyers order', related_name='related_customer')
...
class Order(models.Model):
    ...
    STATUS_CHOICES =(
        ...
        (STATUS_COMPLETED, 'Order complete')
    )

    BYING_TYPE_CHOICES = (
        (BYING_TYPE_SELF, 'You take away'),
        (BYING_TYPE_DELIVERY, 'Delivery')
    )
